...
import { registerAdmin } from '../../src/app/redux/actions/authSlice';
        ...
        return (
            <>
                ...
                <div className={`text`}>
                    ...
                    <ToastContainer />
                    <form className={` flex opacity-100 flex-col w-[85%] md:w-full space-y-10 m-auto`} ref={formRef} onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <p className="text-center absolute w-full mt-3">Already have an account? <Link href="/login">Login</Link></p>
